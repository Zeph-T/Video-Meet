...
import { VIDEO_SERVER_URL } from "../../utilities";
import "./Video.css";

const server_url = VIDEO_SERVER_URL; //process.env.NODE_ENV === 'production' ? 'https://video.sebastienbiollo.com' : "http://localhost:4001"
        ...
        {this.state.askForUsername === true ? (
          ...
          <div>
            <div className="btn-down">
              <IconButton onClick={this.handleVideo} className="button glass-morph">
                {this.state.video === true ? <VideocamIcon /> : <VideocamOffIcon />}
              </IconButton>

              <IconButton style={{ color: "red" }} onClick={this.handleEndCall} className="button glass-morph">
                <CallEndIcon />
              </IconButton>
